...
* fix: revert validation record to count-based approach (#88) @thulasirajkomminar

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-fargate/compare/v3.1.0...v3.1.1
...
* feature: add optional user for task definition (#87) @marceldevroed

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-fargate/compare/v3.0.0...v3.1.0
...
* feat: added variable to support ECS exec (#84) @thulasirajkomminar

**Full Changelog**: https://github.com/schubergphilis/terraform-aws-mcaf-fargate/compare/v2.1.0...v2.2.0
